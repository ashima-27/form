...
export const CheckoutPage = () => {
  return (
    <div className="max-h-screen p-4 flex flex-col items-center mt-8 overflow-hidden">
      ...
      <div className="w-full max-w-6xl gap-5 justify-between flex flex-col md:flex-row  mx-auto bg-white rounded-3xl overflow-hidden ">
